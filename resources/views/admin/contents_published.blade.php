...
@section('title', 'Published Contents')
@section('description', 'Published Contents')

@section('content')
    <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header">Published Contents</h3>
...
@section ('external_js')
    ...
    $(function () {
        $('#contents-table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{{ route('admin::getContentsPublishedApi') }}',
            columns: [
                {data: 'id', name: 'id'},
