	...
	<main>
		<div class="container">
			...
			<div class="review">
				...
				<div class="row">
					<div class="col-md-12">
						<img src="../../images/dashcams/cameras-img.png" alt="cameras-img" class="img-responsive ma">
						<p>YI, or XiaoYi, is one of the world's leading dash cam manufacturers today. Based in China, not to be mistaken for Xiaomi (they have their own line of dash cams), YI has been successful in manufacturing one of the most popular dash cams of 2017, with an excellent price/performance ratio. It's far from perfect, but at its price point offers great value.</p>
					</div>
				</div>
				<div class="row">
					<div class="col-md-12">
						<div class="blue-title mb">
							<h4><img src="../../images/dashcams/info-icon.png" alt="info-icon">Specification</h4>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-4 col-sm-6">
						<div class="white-box">
							<p>Chipset YI A12 (Based on Novatek 96660)</p>
						</div>
					</div>
					<div class="col-md-4 col-sm-6">
						<div class="white-box">
							<p>Speculated to be AR0230CS</p>
						</div>
					</div>
					<div class="col-md-4 col-sm-6">
						<div class="white-box">
					...
					<div class="col-md-4 col-sm-6">
						<div class="white-box">
							<p>Resolutions: 2304x1296 30fps, 1920x1080 60fps, 1920x1080 30fps</p>
						</div>
					</div>
					<div class="col-md-4 col-sm-6">
						<div class="white-box">
							<p>Supports SD cards up to 64GB</p>
						</div>
					</div>
					<div class="col-md-4 col-sm-6">
						<div class="white-box">
					...
					<div class="col-md-4 col-sm-6">
						<div class="white-box">
							<p>Has a 240mAH lithium battery</p>
						</div>
					</div>
					<div class="col-md-4 col-sm-6">
						<div class="white-box">
							<p>Comes with a vacuum holder or a sticker mount, depending on the version (usually sticker mount</p>
						</div>
					</div>
				</div>
				<div class="row">
				...
				<div class="row">
					<div class="col-md-12">
						<p>The YI smart dash cam's build resembles the GOPRO style cameras, including the screen. It comes in two colors - gold and light gray. It is not a very discrete camera, as it can be seen relatively easily when viewed from the outside, which isn't ideal for those not wanting to attract attention, but it can also be helpful if you want to calm a road raging driver you run into.</p>
						<p>YI also manufactures a "compact" black version of this camera which is cheaper and looks the same. Make no mistake, this is a completely different camera in every respect and is inferior. The camera has a 2.7" screen which makes it easier to setup the camera during installation, but since the camera has wifi, it's not an absolute necessity.</p>
						<img src="../../images/dashcams/car-with-camera-photo.png" alt="car-with-camera-photo" class="img-responsive ma">
					</div>
				</div>
				<div class="row">
					<div class="col-md-12">
						<div class="blue-title">
							<h4><img src="../../images/dashcams/package-icon.png" alt="package-icon">Unboxing</h4>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-12">
						...
						<section class="single-item slider">
							<div>
								<img src="../../images/dashcams/slider-img1.png" class="img-responsive ma">
							</div>
						</section>
						<ul class="package-list">
							<li><img src="../../images/dashcams/dot-img.png" alt="dot-img"> Long mini-USB cable</li>
							<li><img src="../../images/dashcams/dot-img.png" alt="dot-img"> A dual or single potr USB cigarette lighter charger</li>
							<li><img src="../../images/dashcams/dot-img.png" alt="dot-img"> Sticker mount or suction cup</li>
							<li><img src="../../images/dashcams/dot-img.png" alt="dot-img"> English (or Chinese) manual</li>
						</ul>
					</div>
				</div>
				<div class="row">
					<div class="col-md-12">
						<div class="blue-title">
							<h4><img src="../../images/dashcams/support-icon.png" alt="support-icon">Comroads support</h4>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-12">
						<p>The Comroads app fully supports the YI dashcam out of the box with no special functions or changes required. Just install the app, sign up, and choose you camera from the wifi list</p>
						<p>The videos below are original and uneditted videos downloaded directly from the camera to the phone through the application and have not been processed at all (unlike YouTube etc.)</p>
					</div>
				</div>
				<div class="row">
					<div class="col-md-12">
				...
				<div class="row">
					<div class="col-md-12">
						<p>The YI dashcam produces excellent daytime video quality for its price point, with a sharp image, especially in 1296P. However, the image sometimes becomes blurred to compared to slightly more expensive cameras.</p>
                        <video class="vid-border img-responsive ma" width="70%"  controls>
                            <source src="http://s31.comroads.com/comroads01/dashcam-review/yi-day.mp4" type="video/mp4">
                        </video>
						<p>Numerous owners of the  YI dashcam have reported that the camera somewhat loses focus after being left in the sun for too long. This does not happen however in all models and there are videos online which explain how to rectify the issue should it occur.</p>
					</div>
				</div>
				<div class="row">
					<div class="col-md-12">
				...
				<div class="row">
					<div class="col-md-12">
						<p>Good quality night video is a rare occurance with dash cams, certainly not in the YI's~$55 price range. The YI does manage to produce acceptable image quality at night, but don't expect any miracles, event at 1080P 60FPS.</p>
                        <video class="vid-border img-responsive ma" width="70%"  controls>
                            <source src="http://s31.comroads.com/comroads01/dashcam-review/yi-dashcam-night.mp4" type="video/mp4">
                        </video>
					</div>
				</div>
				<div class="row">
				...
				<div class="row">
					<div class="col-md-12">
						<p>It's easy to see what makes the YI smart dash cam such a success. It offers great quality for the price, and includes a good wifi setup, which enables full support with the Comroads app out of the box, allowing you to easily retrieve videos from it at the push of a button.</p>
						<p>It's not perfect and it has its issues, including the fact that it contains a battery and not a capacitor (preferable for hotter climates). The bottom line is that if you want a good camera at a low price, the YI seems to be the best choice</p>
					</div>
				</div>
				<hr>
				<h5>BUY NOW</h5>
