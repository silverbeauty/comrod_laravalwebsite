...
<main>
		<div class="container">
			...
			<div class="row">
				<div class="col-md-12">
					<h1>Comroads Recommended Dash-cam</h1>
					<h6>All dash-cam shown below are Comroads supported</h6>
				</div>
			</div>

			<!-- Choose dash cam --> 
			<div class="choose-dash-cam hidden-md hidden-lg">			
				<div class="row">
					<div class="col-md-12">
						<p>Choose Your Dash-cam</p>
						<select>
			...
			<div class="recommendation">
				<div class="row">
					<div class="col-md-4">
						<div class="recommendation-item hidden-sm hidden-xs">
							<h3>Viofo WR1</h3>
							<img src="images/dashcams/viofo-wr1-img.png" alt="viofo-wr1-img" class="img-responsive ma">
							<div class="recommendation-item-buttons-box">
								<a href="/dashcam-review/viofo-wr1#firstvideo"><button>SEE IT IN ACTION <img src="images/dashcams/play-icon.png" alt="play-icon"></button></a>
								<a href="#buynow"><button>BUY NOW <img src="images/dashcams/cart-icon.png" alt="cart-icon"></button></a>
								<a href="/dashcam-review/viofo-wr1"><button>FULL REVIEW <img src="images/dashcams/review-icon.png" alt="review-icon"></button></a>
							</div>
							<div class="item-description">
								<p>Viofo is one of today's leaders in the dash cam market. The WR1 is their first attempt at a Wifi-enabled camera, and a pretty good one at that. This is a small, discrete camera, without a screen, with good video quality and a good price point. </p>
							</div>
							<hr>
							<p>Wifi Speed - <span>Good</span></p>
							<hr>
							<p>Capacitor</p>
							<hr>
							<p>Max Resolution</p>
							...
							<p><span>F1.8</span></p>
							<hr>
							<div class="material-desription">
								<p>Material quality and resistance to heat</p>
								<p><span>Good build. Great heat resistance<span></p>
							</div>
							<hr>
							<p>Screen</p>
							<p><img src="images/dashcams/no.png" alt="no"></p>
							<hr>
							<h5>BUY NOW</h5>
							<div class="row">
								<div class="col-md-12 tac wr1Div">
					...
					<div class="col-md-4">
						<div class="recommendation-item top">
							<div class="top-rated-banner">
								<img src="images/dashcams/top-rated-small-banner.png" alt="top-rated-small-banner">
							</div>
							<h3>Xiaomi YI</h3>
							<img src="images/dashcams/xiaomi-yi-img.png" alt="xiaomi-yi-img" class="img-responsive ma">
							<div class="recommendation-item-buttons-box">
                                <a href="/dashcam-review/yi-dashcam#firstvideo"><button>SEE IT IN ACTION <img src="images/dashcams/play-icon.png" alt="play-icon"></button></a>
								<a href="#buynow"><button>BUY NOW <img src="images/dashcams/cart-icon.png" alt="cart-icon"></button></a>
								<a href="/dashcam-review/yi-dashcam"><button>FULL REVIEW <img src="images/dashcams/review-icon.png" alt="review-icon"></button></a>
							</div>
							<div class="item-description">
								<p>YI (XiaoYI) is becoming a leader in the dash cam world, with the (grey) YI smart dash cam one of the fastest selling dash cams in the world. this camera gives great value for money. It is far from perfect, but it has no competitors in its price range, especially when it's on special.</p>
							</div>
							<hr>
							<p>Wifi Speed - <span>Good</span></p>
							<hr>
							...
							<hr>
							<p>Max Resolution</p>
							<p><span>1296P or 1080P60fps</span></p>
							<hr>
							<p>Recording Angle</p>
							<p><span>160°</span></p>
							<hr>
							...
							<div class="material-desription">
								<p>Material quality and resistance to heat</p>
								<p><span>Medoicre heat resistance. Has been known to lose focus after prolonged exposure to high temperature climate<span></p>
							</div>
							<hr>
							<p>Screen</p>
							<p><img src="images/dashcams/yes.png" alt="yes"></p>
							<hr>
							<h5>BUY NOW</h5>
							<div class="row">
								<div class="col-md-12 tac yiDiv">
					...
					<div class="col-md-4">
						<div class="recommendation-item hidden-sm hidden-xs">
							<h3>Viofo A129</h3>
							<img src="images/dashcams/viofo-a129-img.png" alt="viofo-a129-img" class="img-responsive ma">
							<div class="recommendation-item-buttons-box">
								<a href="/dashcam-review/viofo-a129#firstvideo"><button>SEE IT IN ACTION <img src="images/dashcams/play-icon.png" alt="play-icon"></button></a>
								<a href="#buynow"><button>BUY NOW <img src="images/dashcams/cart-icon.png" alt="cart-icon"></button></a>
								<a href="/dashcam-review/viofo-a129"><button>FULL REVIEW <img src="images/dashcams/review-icon.png" alt="review-icon"></button></a>
							</div>
							<div class="item-description">
								<p>Viofo's A129 is one of the best dash cams released in 2018. It is a dual camera (front/rear 1080p) with excellent image both day and night, and very good WIFI. Although not cheap, it is still great value for money for what it offers.</p>
							</div>
							<hr>
							<p>Wifi Speed - <span>Very Fast</span></p>
							<hr>
							<p>Capacitor</p>
							<hr>
							<p>Max Resolution</p>
							<p><span>1920 x 1080P 30FPS</span></p>
							<hr>
							<p>Recording Angle</p>
							<p><span>140°</span></p>
							<hr>
							...
							<div class="material-desription">
								<p>Material quality and resistance to heat</p>
								<p><span>A129 can be mounted discreetly behind the windshield and is nearly invisible from the outside, perfectly blending into the car<span></p>
							</div>
							<hr>
							<p>Screen</p>
							<p><img src="images/dashcams/yes.png" alt="yes"></p>
							<hr>
							<h5 id="buynow">BUY NOW</h5>
							<div class="row">
								<div class="col-md-12 tac a129Div">
    ...
    <script src="./js/showPrices.js"></script>
	</main>
	<!-- Main part end -->
