<script>
    ...
    var marker;
    var geocoder;
    var latitude = {{ $content->latitude ?: 0 }};
    var longitude = {{ $content->longitude ?: 0 }};           

    function initMap(geocode_by_address) {
        geocoder = new google.maps.Geocoder();

        if (typeof geocode_by_address !== 'undefined' || (!latitude && !longitude)) {
